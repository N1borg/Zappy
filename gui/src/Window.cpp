...
{
    DrawText(TextFormat("X:%f Y:%f Z:%f", _camera.position.x, _camera.position.y, _camera.position.z), 10, 20, 20, GRAY);
    DrawText(TextFormat("Map size: (%d, %d)", map.getWidth(), map.getHeight()), 10, 40, 20, GRAY);
    DrawText(TextFormat("Frequency: %d", map.getFrequency()), 10, 60, 20, GRAY);
    DrawText(TextFormat("Camera mode: %d", getCameraMode()), 10, 80, 20, GRAY);
    DrawText(TextFormat("Teams: N/A", map.getNbTeams()), 10, 120, 20, GRAY);
    DrawText(TextFormat("Players: %d", map.getNbPlayers()), 10, 100, 20, GRAY);
    DrawText(TextFormat("Eggs: %d", map.getNbEggs()), 10, 140, 20, GRAY);
    DrawText(TextFormat("Food: %d", map.getNbFood()), 10, 160, 20, GRAY);
    DrawText(TextFormat("Linemate: %d", map.getNbLinemate()), 10, 180, 20, GRAY);
    DrawText(TextFormat("Deraumere: %d", map.getNbDeraumere()), 10, 200, 20, GRAY);
    DrawText(TextFormat("Sibur: %d", map.getNbSibur()), 10, 220, 20, GRAY);
    DrawText(TextFormat("Mendiane: %d", map.getNbMendiane()), 10, 240, 20, GRAY);
    DrawText(TextFormat("Phiras: %d", map.getNbPhiras()), 10, 260, 20, GRAY);
    DrawText(TextFormat("Thystame: %d", map.getNbThystame()), 10, 280, 20, GRAY);
}

void Window::drawTileInfo(Tile_t tile)
{
    DrawText(TextFormat("Players: %d", tile.players.size()), _width - MeasureText(TextFormat("Players: %d", tile.players.size()), 20) - 10, 20, 20, GRAY);
    DrawText(TextFormat("Eggs: %d", tile.eggs.size()), _width - MeasureText(TextFormat("Eggs: %d", tile.eggs.size()), 20) - 10, 40, 20, GRAY);
    DrawText(TextFormat("Food: %d", tile.food.second), _width - MeasureText(TextFormat("Food: %d", tile.food.second), 20) - 10, 60, 20, GRAY);
    DrawText(TextFormat("Linemate: %d", tile.linemate.second), _width - MeasureText(TextFormat("Linemate: %d", tile.linemate.second), 20) - 10, 80, 20, GRAY);
    DrawText(TextFormat("Deraumere: %d", tile.deraumere.second), _width - MeasureText(TextFormat("Deraumere: %d", tile.deraumere.second), 20) - 10, 100, 20, GRAY);
    DrawText(TextFormat("Sibur: %d", tile.sibur.second), _width - MeasureText(TextFormat("Sibur: %d", tile.sibur.second), 20) - 10, 120, 20, GRAY);
    DrawText(TextFormat("Mendiane: %d", tile.mendiane.second), _width - MeasureText(TextFormat("Mendiane: %d", tile.mendiane.second), 20) - 10, 140, 20, GRAY);
    DrawText(TextFormat("Phiras: %d", tile.phiras.second), _width - MeasureText(TextFormat("Phiras: %d", tile.phiras.second), 20) - 10, 160, 20, GRAY);
    DrawText(TextFormat("Thystame: %d", tile.thystame.second), _width - MeasureText(TextFormat("Thystame: %d", tile.thystame.second), 20) - 10, 180, 20, GRAY);
}
